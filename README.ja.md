<p align="center">
  <img src="./assets/banner.svg" alt="XXD Panel 020 プロジェクトバナー" width="1200">
</p>

<div align="center">

# 🦁 XXD Panel 020｜厚塗りミニ風景

### 写真を、本物の厚塗りに埋め込まれた触覚的な立体ミニチュアへ

[![Codex Skill](https://img.shields.io/badge/Codex-Skill-000000?style=flat-square)](./SKILL.md)
[![Four Modes](https://img.shields.io/badge/Modes-4-d75d32?style=flat-square)](#組み合わせ可能な4つの出力)
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090148356597428723"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 020 作例 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090148356597428723"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 020 作例 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090148356597428723"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 020 作例 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090148356597428723"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 020 作例 4"></a></td>
  </tr>
</table>
...
上の 16:9 作例と同じ4点の独立素材を、完全な 3:4 上下構成として再生成しました。上部は現実の写真を保ち、下部は Panel 020 の原文プロンプトに従って再構成しています。英語コピーは各写真の内容・空気・含意だけから生成し、全点を個別に確認しました。

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 020 追加上下作例 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 020 追加上下作例 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 020 追加上下作例 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 020 追加上下作例 4"></td>
  </tr>
</table>
...
<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2090148356597428723">元の投稿と完全なプロンプトを見る →</a></p>

この四つの原作例が 020 のスタイルを共同で定義します。パレットナイフの厚塗り、立体ミニチュア場面、粗い紙面、抑制された編集文字です。個別の被写体、色、文言、旧比率は固定テンプレートになりません。

> 厚塗りの島 · 立体ミニチュア · 本物のナイフ跡 · 大きな紙面余白 · 抑制された編集文字

020 は写真の置き換えられない被写体、動作、関係を保ち、厚い顔料へ埋め込まれた小型立体、レリーフ、彫刻的絵画として再構築します。粗い暖白紙に一つの不規則な厚塗り島を置き、盛り上がり、掻き跡、断辺、露底、厚みによる影で場面を支えます。
...
**Panel 020** は、原写真の核を保ちながら、次の視覚方向を目指す制作に向いています：**写真を、本物の厚塗りに埋め込まれた触覚的な立体ミニチュアへ**。まず用途と期待する結果を確認し、そこから構図、サイズ、文字、納品形式を決めます。
...
> XXD Panel 020 でこの画像を処理して、まず最適な構図とサイズを提案して。
...
| 知りたいこと | このスタイルの答え |
|---|---|
| **得られる完成作品** | 元写真を、厚塗りへ埋め込まれた立体ミニチュア場面へ再構築 |
| **ひと目で分かる特徴** | 厚塗りの島 · 立体ミニチュア · 本物のナイフ跡 · 大きな紙面余白 · 抑制された編集文字 |
...
一般的な厚塗り風は、装飾的な飛沫、プラスチック 3D 玩具、または長方形枠へ貼った縮小場面になりがちです。020 は顔料、ミニチュア主体、色、文言を元写真へ結びつけます。

```text
被写体／動作／関係／感情を識別 → 無関係な背景を削除 → 元写真の強い色関係を抽出 → 厚塗り島の方向と尺度を決定 → 被写体を顔料へ埋め込んだ立体として造形 → 盛り上がり／掻き跡／断辺／厚みの影を表現 → 紙面余白へ元写真に結びつく文字だけを置く
```

無関係な写真へ替えても厚塗り島、ミニチュア主体、色関係、文言が成立するなら 020 ではありません。

## 完成作品で識別しやすい特徴

- 被写体、動作、核心関係が一目で分かる。
- 方向性のある厚塗り島が唯一の視覚アンカーになる。
- 盛り上がり、稜線、断辺、露底、光沢、厚みの影が見える。
- ミニチュアは顔料から生え、沈み、重なり、支えられる。矩形枠へ貼らない。
- 主色域は元写真の意味ある色関係から導き、固定色票を使わない。
- 粗い暖白・象牙紙の大きな余白を保つ。
- 文言は写真に強く結びつき、正確なユーザー文はそのまま使う。

<details>
<summary><strong>全機能と引数（必要なときに開く）</strong></summary>

## 校正版スタイル指示を唯一の美的基準にする

`references/original-prompt/zh-CN.md` は、校正された 020 指示であり、このプロジェクト唯一の創作・美的基準です。Skill は原文を要約・拡張せず、共通の配色計画、美的動機、タイトル、マイクロコピーを追加しません。色、素材、構図、余白、言葉、タイポグラフィは、GPT Image 2 が原文プロンプトの規則どおりに実行します。
...
画像フォルダーを直接渡すと、この兵士 Skill が同じ Panel 020 の原文美学で一括処理します。一般的なラスター形式を既定で再帰検索し、件数を報告してから、モード・サイズ・文字・言語を一度だけ確認します。各画像は内容や文言を混ぜず独立生成し、バッチ全体は一つのフラットなタスクフォルダーへ保存します。個別の失敗は記録し、後続画像を黙って省略しません。
...
/xxd-panel-020 photo.jpg --mode top-bottom --size auto --text prompt --locale ja-JP

# 左右比較：3:2 横長、文字なし
/xxd-panel-020 photo.jpg --mode left-right --size 3:2 --text none

# デザインのみ：9:16 スマートフォン縦長、日本語文字
/xxd-panel-020 photo.jpg --mode design-only --size 9:16 --text prompt --locale ja-JP
...
/xxd-panel-020 photo.jpg --mode design-only --size 3:4 --text prompt --locale ja-JP

# 正確な文言を、書き換え・翻訳・タイトル追加なしで使用
/xxd-panel-020 photo.jpg --mode design-only --size 3:4 --copy "光をここに残す" --locale ja-JP

# 2モード × 3サイズで独立した完成構図を6枚生成
/xxd-panel-020 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ja-JP

# フォルダー全体へ Panel 020 を適用し、共通設定は一度だけ解決
/xxd-panel-020 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ja-JP
