...
# 🦁 XXD Panel 020｜منظر مصغّر بطلاء سميك

### أعد بناء الصورة كمشهد مصغّر مجسّم منغرس في طلاء كثيف حقيقي

[![Codex Skill](https://img.shields.io/badge/Codex-Skill-000000?style=flat-square)](./SKILL.md)
[![Four Modes](https://img.shields.io/badge/Modes-4-d75d32?style=flat-square)](#أربعة-مخرجات-قابلة-للجمع)
...
تعيد هذه الأعمال الأربعة استخدام المصادر المستقلة نفسها في مجموعة 16:9 أعلاه، لكن داخل لوحات كاملة 3:4 بتكوين أعلى–أسفل. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 020. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 020 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 020 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 020 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 020 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>
...
تحدد النماذج الأصلية الأربعة هوية 020 معاً: طلاء كثيف بسكين الرسم، مشاهد مصغّرة مجسمة، ورق خشن، وكتابة تحريرية رصينة. ولا تتحول موضوعاتها أو ألوانها أو نصوصها أو نسبتها القديمة إلى قالب ثابت.

> جزيرة طلاء كثيف · مشهد مصغّر مجسّم · آثار سكين حقيقية · فراغ ورقي واسع · كتابة تحريرية رصينة

يحفظ 020 موضوع الصورة وفعلها وعلاقتها التي لا يمكن استبدالها، ثم يعيد بناءها كجسم مصغّر أو نقش بارز أو لوحة نحتية منغرسة في الصبغة السميكة. تدعم المشهد جزيرة طلاء غير منتظمة فوق ورق أبيض دافئ خشن، مع تراكم وكشط وحواف مكسورة وأرضية ظاهرة وظلال ناتجة عن السماكة.
...
يناسب **Panel 020** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **أعد بناء الصورة كمشهد مصغّر مجسّم منغرس في طلاء كثيف حقيقي**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 020 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## موجز الأسلوب المصحح · خمس لغات

[فتح دليل اللغات](references/original-prompt/): [الموجز الصيني المصحح](references/original-prompt/zh-CN.md) · [English](references/original-prompt/en.md) · [日本語](references/original-prompt/ja.md) · [한국어](references/original-prompt/ko.md) · [العربية](references/original-prompt/ar.md)

كرر نص منشور 020 عن طريق الخطأ توجيه 015 الهندسي التجريدي، رغم عنوان «طلاء كثيف × تجسيم» والنماذج الأربعة المتسقة. توثق [ملاحظة المصدر](references/original-prompt/source-tweet-body-2026-08-19.md) هذا التعارض. الموجز الصيني المصحح المعاد بناؤه من النماذج الأربعة هو المرجع الوحيد وقت التشغيل، أما اللغات الأخرى فترجمات قراءة أمينة.

<!-- xxd-panel-benefit:start -->
## تحقق سريع: هل XXD Panel 020 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | إعادة بناء المشهد كمجسم مصغّر منغرس في طلاء كثيف |
| **السمات التي تُعرف من النظرة الأولى** | جزيرة طلاء كثيف · مشهد مصغّر مجسّم · آثار سكين حقيقية · فراغ ورقي واسع · كتابة تحريرية رصينة |
...
## كيف يحول المصدر إلى نتيجة مميزة

يتحول أسلوب الطلاء الكثيف العام بسهولة إلى بقعة زخرفية أو لعبة بلاستيكية ثلاثية الأبعاد أو مشهد مصغّر ملصق داخل إطار مستطيل. يربط 020 الصبغة والموضوع المصغّر واللون والنص بالمصدر نفسه.

```text
تحديد الموضوع والفعل والعلاقة والعاطفة ← حذف الخلفية غير المهمة ← اشتقاق أقوى علاقة لونية من المصدر ← تحديد اتجاه جزيرة الطلاء وحجمها ← تشكيل الموضوع كمجسم منغرس في الصبغة ← إظهار التراكم والكشط والحواف المكسورة وظلال السماكة ← وضع نص مرتبط بالمصدر فقط في الفراغ الورقي
```

إذا أمكن استبدال الصورة بأخرى غير مرتبطة من دون تغير جوهري في جزيرة الطلاء أو الموضوع المصغّر أو علاقة اللون أو النص، فالنتيجة ليست 020.

## السمات التي تميز النتيجة

- يبقى الموضوع والفعل والعلاقة الأساسية قابلة للتعرف فوراً.
- تشكل جزيرة طلاء اتجاهية واحدة المرساة البصرية الوحيدة.
- تظهر التراكمات والنتوءات والحواف المكسورة والأرضية المكشوفة واللمعان وظلال السماكة.
- ينمو المجسم من الصبغة أو يغوص فيها أو يتراكب معها أو يستند إليها، ولا يلصق داخل إطار مستطيل.
- يأتي مجال اللون الرئيسي من علاقة لونية ذات معنى في المصدر، لا من لوحة ثابتة.
- يبقى فراغ واسع من الورق الخشن الأبيض الدافئ أو العاجي.
- يرتبط النص بالصورة بقوة، وينقل نص المستخدم الدقيق حرفياً.

<details>
<summary><strong>كل الإمكانات والمعاملات (افتحها عند الحاجة)</strong></summary>

## موجز الأسلوب المصحح هو المرجع الجمالي الوحيد

الملف `references/original-prompt/zh-CN.md` هو موجز 020 المصحح والمرجع الإبداعي والجمالي الوحيد للمشروع. يمنع استمرار استخدام النص الهندسي المكرر من 015. لا تلخّص المهارة نصّه ولا توسعه، ولا تفرض لوحة ألوان مشتركة أو «دافعاً جمالياً» أو عنواناً أو حزمة نصوص قصيرة؛ ويتبع مولد الصور قواعده في اللون والخامة والتكوين والفراغ والنص والطباعة.
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 020. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-020 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-020 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-020 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-020 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-020 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 020 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-020 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
- [مهايئ التشغيل الصيني](references/xxd-panel-020-prompt.zh-CN.md)
- [مهايئ التشغيل الإنجليزي](references/xxd-panel-020-prompt.en.md)
...
**للطلاء وزن، ويحفظ المشهد المصغّر ذاكرة الصورة.**
