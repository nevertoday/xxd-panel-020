...
لهذا الإحباط صنعت **Panel 020**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **يقطّر الصورة في ذاكرة تجريدية دنيا ونظام تحريري كامل**.
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 020 نموذج 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 020 نموذج 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 020 نموذج 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 020 نموذج 8"></td>
  </tr>
</table>
...
|---|---|
| **النتيجة التي ستحصل عليها** | يقطّر الصورة في ذاكرة تجريدية دنيا ونظام تحريري كامل |
| **السمات التي تُعرف من النظرة الأولى** | تفكيك—اختيار—تقطير—إعادة بناء · أشكال قليلة · أدوار لونية صارمة · فراغ عاجي · نص مجهري لكتاب فني |
