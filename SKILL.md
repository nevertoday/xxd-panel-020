---
name: xxd-panel-020
description: "Create XXD Panel 020 raster artwork while treating the bundled original style brief as the sole aesthetic authority. Supports one or more top-bottom, left-right, design-only, and four-device wallpaper outputs; multiple ratios or exact sizes; prompt-generated, user-exact, or text-free typography; and inline parameters. Use when the user invokes xxd-panel-020 or requests the exact Panel 020 style."
---
...
```text
/xxd-panel-020 <source> --mode top-bottom,design-only \
