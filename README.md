...
我做 **Panel 020**，就是想解决这个别扭。它不是给照片硬套模板，而是先认出照片里真正不能丢的东西，再把它翻译成：**把照片提炼成极简抽象记忆与完整编辑系统**。
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 020 样张 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 020 样张 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 020 样张 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 020 样张 8"></td>
  </tr>
</table>
...
| 你关心的问题 | 这套风格给你的回答 |
|---|---|
| **你会得到什么** | 把照片提炼成极简抽象记忆与完整编辑系统 |
| **一眼可辨的特点** | 解构—筛选—提炼—重构 · 少量形体 · 严格色彩角色 · 象牙色留白 · 艺术书微排版 |
